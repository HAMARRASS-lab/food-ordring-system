...
import com.hamza.foodordringsystem.commondomain.valueobject.*;
import com.hamza.foodordringsystem.orderdomaincore.exception.OrderDomainException;
import com.hamza.foodordringsystem.orderdomaincore.valueobject.OrderItemId;
...
public class Order extends AggregateRoot<OrderId> {
    ...
    private final RestaudantId restaudantId;
    ...
    private Order(Builder builder) {
        ...
        restaudantId = builder.restaudantId;
    ...
    public RestaudantId getRestaudantId() {
        return restaudantId;
    }
